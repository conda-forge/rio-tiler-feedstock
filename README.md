...
Once the `conda-forge` channel has been enabled, `rio-tiler` can be installed with:

```
conda install rio-tiler
```

It is possible to list all of the versions of `rio-tiler` available on your platform with:
